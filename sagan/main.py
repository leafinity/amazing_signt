...
def parse_args():
    ...
    parser.add_argument('--load_all', action='store_true', default=False, help='load all image')
...
#     trainer.gabove.save_weights('gabove.h5')
#     trainer.gbelow.save_weights('gbelow.h5')
#     trainer.dabove.save_weights('dabove.h5')
#     trainer.dbelow.save_weights('dbelow.h5')

    print(trainer.g.summary())
    print(trainer.d.summary())
