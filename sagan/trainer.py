...
class Trainer(object):
    ...
    def __init__(self, config):
        ...
        if config.restore_model or config.train is False:
            self.restore_model()
        else:
...
#         print("load_weights")
#         self.gabove.load_weights('/home/jovyan/ta-hsi/abby_project/abby/SAGAN-tensorflow2.0/gabove.h5')
#         self.gbelow.load_weights('/home/jovyan/ta-hsi/abby_project/abby/SAGAN-tensorflow2.0/gbelow.h5')
        
#         self.dabove.load_weights('/home/jovyan/ta-hsi/abby_project/abby/SAGAN-tensorflow2.0/dabove.h5')
#         self.dbelow.load_weights('/home/jovyan/ta-hsi/abby_project/abby/SAGAN-tensorflow2.0/dbelow.h5')

        self.epoch_start = int(g_latest.split('/')[-1][3:].split('.')[0]) + 1
    ...
    def train(self):
        ...
        print('print_freq', self.print_freq, 'save_freq', self.save_freq)
...
#             if (epoch - self.epoch_start) < self.print_freq:
